                            ...
                            <div class="row">
                                <div class="m-abstract__content col-sm-12 col-md-8">
                                    <div class="a-richtext a-richtext--abstract">
                                        <p>نصب استیل روکش درب اتوماتیک ،تولید کننده ی فیکسر ، پارک پلیت ، رولر و پاراشوت  کارسلینگ با بهره گیری از دانش فنی نیروهای متخصص این شرکت <br>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="h-layout__colctrl-item">
                                <div class="m-text-image " data-t-name="">
                                        ...
                                        <a class="m-text-image__link" target="_self"
                                            ...
                                            <picture class="a-responsive-image js-a-responsive-image  "
                                                ...
                                                <div class="a-loader js-a-loader" data-t-name="Loader">
                                                    ...
                                                    data-src="/img/other/1.jpg"
                                                    data-srcset="/img/other/1.jpg 1200w, /img/other/1.jpg 992w, /img/other/1.jpg 768w, /img/other/1.jpg 480w, /img/other/1.jpg 240w"
                                                    src="/img/other/1.jpg"
                                                     /><noscript><img
                                                        src="/img/other/1.jpg"
                                    ...
                                    <h2 class="m-text-image__title">استیل درب تمام اتوماتیک DS-D22G </h2>
                        ...
                        <div class="col-md-6">
                            <div class="h-layout__colctrl-item">
                                <div class="m-text-image " data-t-name="">
                                        ...
                                        <a class="m-text-image__link" target="_self"
                                            ...
                                            <picture class="a-responsive-image js-a-responsive-image  "
                                                ...
                                                <div class="a-loader js-a-loader" data-t-name="Loader">
                                                    ...
                                                    data-src="/img/other/2.jpg"
                                                    data-srcset="/img/other/2.jpg 1200w, /img/other/2.jpg 992w, /img/other/2.jpg 768w, /img/other/2.jpg 480w, /img/other/2.jpg 240w"
                                                    src="/img/other/2.jpg"
                                                     /><noscript><img
                                                        src="/img/other/2.jpg"
                                                        class="a-responsive-image__img--fallback"
                                    ...
                                    <h2 class="m-text-image__title">استیل درب تمام اتوماتیک کد DS-D24</h2>
                                    <div class="m-text-image__text">
                                        <div class="a-richtext" data-t-name="Richtext">
                                            <p>
                                                </br>
                        ...
                        <div class="col-md-6">
                            <div class="h-layout__colctrl-item">
                                <div class="m-text-image " data-t-name="">
                                        ...
                                        <a class="m-text-image__link" target="_self"
                                            ...
                                            <picture class="a-responsive-image js-a-responsive-image  "
                                                ...
                                                <div class="a-loader js-a-loader" data-t-name="Loader">
                                                    ...
                                                    data-src="/img/other/3.jpg"
                                                    data-srcset="/img/other/3.jpg 1200w, /img/other/3.jpg 992w, /img/other/3.jpg 768w, /img/other/3.jpg 480w, /img/other/3.jpg 240w"
                                                    src="/img/other/3.jpg"
                                                    /><noscript><img
                                                        src="/img/other/3.jpg"
                                                        class="a-responsive-image__img--fallback"
                                    ...
                                    <h2 class="m-text-image__title">استیل درب تمام اتوماتیک کد DS-D10G</h2>
                                    <div class="m-text-image__text">
                                        <div class="a-richtext" data-t-name="Richtext">
                                            <p>
                                                </p>
                        ...
                        <div class="col-md-6">
                            <div class="h-layout__colctrl-item">
                                <div class="m-text-image " data-t-name="">
                                        ...
                                        <a class="m-text-image__link" target="_self"
                                            ...
                                            <picture class="a-responsive-image js-a-responsive-image  "
                                                ...
                                                <div class="a-loader js-a-loader" data-t-name="Loader">
                                                    ...
                                                    data-src="/img/other/4.jpg"
                                                    data-srcset="/img/other/4.jpg 1200w, /img/other/4.jpg 992w, /img/other/4.jpg 768w, /img/other/4.jpg 480w, /img/other/4.jpg 240w"
                                                    src="/img/other/4.jpg"
                                                     /><noscript><img
                                                        src="/img/other/4.jpg"
                                                        class="a-responsive-image__img--fallback"
                                    ...
                                    <h2 class="m-text-image__title">استیل درب تمام اتوماتیک کد DS-D11BK</h2>
                                    <div class="m-text-image__text">
                                        <div class="a-richtext" data-t-name="Richtext">
                                            <p>
