                            ...
                            <div class="row">
                                <div class="m-abstract__content col-sm-12 col-md-8">
                                    <div class="a-richtext a-richtext--abstract">
                                        <p>تولید کننده ی  کارسلینگ های طرح ویتور به صورت لیزر کاری شده و اتصالات تمام پیچ و مهره با قابلیت تنظیم ارتفاع و عمق ، برای دهنه ی ریل های 70 و 80 و 90 می باشد .همچنین کارسلینگ های این شرکت قابل مونتاژ داخل چاه آسانسور می باشند. <br>
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <a class="m-text-image__link" target="_self"
                                            ...
                                            <picture class="a-responsive-image js-a-responsive-image  "
                                                ...
                                                <div class="a-loader js-a-loader" data-t-name="Loader">
                                                    ...
                                                    data-src="/img/carsling/1.jpg"
                                                    data-srcset="/img/carsling/1.jpg 1200w, /img/carsling/1.jpg 992w, /img/carsling/1.jpg 768w, /img/carsling/1.jpg 480w, /img/carsling/1.jpg 240w"
                                                    src="/img/carsling/1.jpg"
                                                   /><noscript><img
                                                        src="/img/carsling/1.jpg" class="a-responsive-image__img--fallback"
                                                        /></noscript>
                                            </picture>
                                        </a>
                                    </div>
                                    <h2 class="m-text-image__title">کارسلینگ طرح ویتور</h2>
                                        ...
                                        <a class="m-text-image__link" target="_self"
                                            ...
                                            <picture class="a-responsive-image js-a-responsive-image  "
                                                ...
                                                <div class="a-loader js-a-loader" data-t-name="Loader">
                                                    ...
                                                    data-src="/img/carsling/2.jpg"
                                                    data-srcset="/img/carsling/2.jpg 1200w, /img/carsling/2.jpg 992w, /img/carsling/2.jpg 768w, /img/carsling/2.jpg 480w, /img/carsling/2.jpg 240w"
                                                    src="/img/carsling/2.jpg"
                                                   /><noscript><img
                                                        src="/img/carsling/2.jpg" class="a-responsive-image__img--fallback"
                                                       /></noscript>
                                            </picture>
                                        </a>
                                    </div>
                                    <h2 class="m-text-image__title">رولر و پاراشوت کارسلینگ</h2>
                                    <div class="m-text-image__text">
                                        <div class="a-richtext" data-t-name="Richtext">
                                            <p>
                                                </br>
